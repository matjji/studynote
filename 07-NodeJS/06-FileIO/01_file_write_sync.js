...
if (!isExists) {
  ...
  // 이 파일을 다 저장하기 전까지 프로그램이 대기상태임.
  // 그러므로 대용량 처리에는 적합하지 않음.
  fs.writeFileSync(target, content, 'utf8');

  // 퍼미션 설정
  fs.chmodSync(target, '0766'); // 0은 파일, 1은 폴더 
  // 본인 7은 r=4 w=2 x= 1 다 더해서 7 읽기 쓰기 실행 권한 다있음
  // 그룹 6은 r=4 w=2 더해서 6 읽기 쓰기 권한 있음
  // 개인 6은 r=4 w=2 더해서 6 읽기 쓰기 권한 있음
