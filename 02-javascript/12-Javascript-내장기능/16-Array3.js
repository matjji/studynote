...
arr.forEach((v, i) => {
    if (i == 3) {
        ...
        //break
        //forEach의 콜백함수에서 반복을 중단하고자 return을 사용할 경우 현재
        //동작중인 콜백만 종료될 뿐 전체 반복에는 영향이 없다.
        return;
    }
    console.log("%d번쨰 원소 ==> %d", i, v)
})
...
arr.some((v, i) => {
    //some 함수는 콜백함수가 true를 리턴하는 순간 순환을 종료한다
    if( i== 3) {
        console.log("~~~ 반복중단!!!");
        return true
    }
